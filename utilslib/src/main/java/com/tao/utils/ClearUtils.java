...
public class ClearUtils {
	...
	*/  
	...
	if (p == null) {  
	Log.e("clearAppUserData","Clear app data packageName:" + packageName  
	+ ", FAILED !");  
	} else {  
		Log.e("clearAppUserData","Clear app data packageName:" + packageName  
	+ ", SUCCESS !");  
	...
	public static Process execRuntimeProcess(String commond) {  
		...
		p = Runtime.getRuntime().exec(commond);  
			...
			Log.e("clearAppUserData","exec Runtime commond:" + commond + ", IOException" + e);  
		e.printStackTrace();  
		}  
		Log.v("clearAppUserData","exec Runtime commond:" + commond + ", Process:" + p);  
		return p;  
		}  
